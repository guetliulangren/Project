		...
		<div id="side-nav">
			<ul id="nav">
				<li><a href="javascript:;"> <i class="iconfont left-nav-li"
						lay-tips="用户管理">&#xe6b8;</i> <cite>产品管理</cite> <i
						class="iconfont nav_right">&#xe697;</i></a>
					<ul class="sub-menu">

						<li><a
							onclick="xadmin.add_tab('查看已上架产品','  ${app_context}/first/product',true)"> 
							<i class="iconfont">&#xe6a7;</i> 
							<cite>查看已上架产品</cite>
							</a>
						</li>
				...
				<i class="iconfont nav_right">&#xe697;</i>
					...
					<ul class="sub-menu">
						...
						<li>
						<a onclick="xadmin.add_tab('查看库存','${app_context}/first/farmresposity')">
						<i class="iconfont">&#xe6a7;</i> 
						<cite>查看库存</cite>
						</a>
						</li>
				...
				<i class="iconfont nav_right">&#xe697;</i>
					...
					<ul class="sub-menu">
						...
						<a onclick="xadmin.add_tab('收购图表分析','${app_context}/first/graph')">
						 ...
						 <li>
						<a onclick="xadmin.add_tab('收购图表分析','${app_context}/first/caculaticegrap')">
