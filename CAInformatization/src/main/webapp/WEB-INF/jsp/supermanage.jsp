...
<body class="index">
        ...
        <div class="container">
            ...
            <ul class="layui-nav right" lay-filter="">
                <li class="layui-nav-item">
                    <a href="javascript:;"> ${superman}</a>
                    <dl class="layui-nav-child">
                        <!-- 二级菜单 -->
                        <dd>
                            <a  onclick="xadmin.add_tab('个人信息','  ${app_context}/first/querymanagerinfo',true)">个人信息</a></dd>
                        <dd>
                            <a href="${app_context}/login/signout">切换账号</a></dd>
                        <dd>
                            <a href="${app_context}/login/signout">退出</a></dd>
                    </dl>
                </li>
		...
		<div id="side-nav">
			<ul id="nav">
				...
				<i class="iconfont nav_right">&#xe697;</i>
					...
					<ul class="sub-menu">
					   ...
					   <li>
						<a onclick="xadmin.add_tab('库存信息','${app_context}/first/queryall')">
						<i class="iconfont">&#xe6a7;</i> 
						<cite>查看库存</cite>
						</a>
						</li>
				...
				<i class="iconfont nav_right">&#xe697;</i>
					...
					<ul class="sub-menu">
						<li>
						<a onclick="xadmin.add_tab('发布公告','${app_context}/first/notice')">
						 <i class="iconfont">&#xe6a7;</i> 
						 <cite>发布公告</cite>
						 </a>
						 </li>
			...
			<!-- 	end -->
				...
				<i class="iconfont nav_right">&#xe697;</i>
					...
					<ul class="sub-menu">
						<li>
						<a onclick="xadmin.add_tab('修改密码','${app_context}/first/repassword')">
						 <i class="iconfont">&#xe6a7;</i> 
						 <cite>修改密码</cite>
						 </a>
						 </li>
