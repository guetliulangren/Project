	 ...
	 /* 发送ajax请求 */
...

		{
			...
			$("<tr></tr>").append(head1).append(head2).append(
					head3).append(head9).append(head4).append(head5)
			...
			$.each(product, function(index, items) {
				...
				$("<tr></tr>").append(productsType).append(productsPrice).append(
						productsNumber).append(productsStatus).append(productsName).append(productstime).append(productsfamername).append(productsphone).append(productsaddress)
