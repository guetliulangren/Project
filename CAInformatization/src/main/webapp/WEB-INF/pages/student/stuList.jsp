...
<div class="container">
			...
			<nav class="navbar navbar-inverse">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#">公司农户信息化管理系统</a>
					</div>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<a class="btn btn-primary" href="#" id="add">添加数据</a>
			<div class="btn-group">
			...
			<table id="grid-data" class="table table-condensed table-hover table-striped">
				...
				<tr>
					...
					<th data-column-id="stuName">Name</th>
					<th data-column-id="stuAge">Age</th>
					<th data-column-id="stuMajor" data-order="desc">Major</th>
